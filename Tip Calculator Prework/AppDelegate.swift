...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func loadTipAndBillAmounts(){
        ...
        if !anyTipAmounts{
            ...
            if let tipAmount = tipDefaults.value(forKey: dataLayer.tipPercentData.defaultTipPercentageKey) as? String{ defaultTip = tipDefaults.string(forKey: dataLayer.tipPercentData.defaultTipPercentageKey)!; defaultTipFound = true; print("AppDeletage: Found default tip value from UserDefaults.....setting to data model...default tip percent: \(defaultTip)");}
    ...
    func applicationWillResignActive(_ application: UIApplication) {
        ...
        print("AppDelegate: TipME is about to move into an in-active state");
    }
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        dataLayer.updateBillAmount();
        dataLayer.updateDefaultTipPercentage();
        print("AppDelegate: TipME just entered the background");
    }
    ...
    func applicationWillEnterForeground(_ application: UIApplication) {
        ...
        self.loadTipAndBillAmounts();
        print("AppDelegate: TipME will enter the foreground");
    }
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        dataLayer.updateBillAmount();
        dataLayer.updateDefaultTipPercentage();
        print("AppDelegate: TipME is about to quit");
    }
}
